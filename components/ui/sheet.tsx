      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close data-slot="sheet-close" asChild>
            <Button
              variant="ghost"
              className="absolute top-4 right-4 z-50 text-ink-muted hover:text-ink hover:bg-canvas-soft rounded-full cursor-pointer"
              size="icon-sm"
            >
