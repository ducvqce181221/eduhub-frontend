  ...
  async function onSubmit(values: ResetPasswordFormValues) {
    ...
    try {
      ...
      if (err?.statusCode === 401 || err?.statusCode === 400) {
        setErrorMessage("This password reset token has expired or is invalid. Please request a new one.");
      } else {
        ...
        <CardContent>
          {isSuccess ? (
            <div className="text-center py-4 space-y-4">
              ...
              <h3 className="text-base font-semibold text-ink">Password Reset Complete</h3>
              ...
              <div className="pt-2">
                <Link
                  href="/login"
                  className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-notion-blue text-white text-sm font-medium hover:bg-notion-blue-active transition-colors shadow-xs"
                >
